...
* Serveur web pour l'API HTTP qui renvoit les statuts des requêtes, avec les éventuels résultats, ou une erreur s'il y a un problème. Voir [`../doc/API_HTTP.md`](../doc/API_HTTP.md).
