...
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_1_LINK_FINDER_THREADS 
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_2_TWEETS_INDEXER_THREADS
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_3_REVERSE_SEARCH_THREADS
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_4_FILTER_RESULTS_THREADS
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_A_SEARCHAPI_LIST_ACCOUNT_TWEETS_THREADS
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_B_TIMELINEAPI_LIST_ACCOUNT_TWEETS_THREADS
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_C_SEARCHAPI_INDEX_ACCOUNT_TWEETS
MAX_FILE_DESCRIPTORS += 1500 * NUMBER_OF_STEP_D_TIMELINEAPI_INDEX_ACCOUNT_TWEETS
