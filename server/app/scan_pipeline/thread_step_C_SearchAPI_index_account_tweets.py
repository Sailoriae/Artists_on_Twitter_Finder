...
def thread_step_C_SearchAPI_index_account_tweets( thread_id : int, shared_memory ) :
    ...
    shared_memory.threads_registry.set_request( "thread_step_C_SearchAPI_index_account_tweets_number" + str(thread_id), None )
    ...
    while shared_memory.keep_service_alive :
        ...
        # Dire qu'on est en train de traiter cette requête
        shared_memory.threads_registry.set_request( "thread_step_C_SearchAPI_index_account_tweets_number" + str(thread_id), request )
